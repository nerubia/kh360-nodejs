/*
  ...
  - You are about to alter the column `invoice_amount` on the `invoices` table. The data in that column could be lost. The data in that column will be cast from `Decimal(8,2)` to `Decimal(12,2)`.
  - You are about to alter the column `tax_amount` on the `invoices` table. The data in that column could be lost. The data in that column will be cast from `Decimal(8,2)` to `Decimal(12,2)`.
  - You are about to alter the column `payment_amount` on the `invoices` table. The data in that column could be lost. The data in that column will be cast from `Decimal(8,2)` to `Decimal(12,2)`.
  - You are about to alter the column `discount_amount` on the `invoices` table. The data in that column could be lost. The data in that column will be cast from `Decimal(8,2)` to `Decimal(12,2)`.
  - You are about to alter the column `sub_total` on the `invoices` table. The data in that column could be lost. The data in that column will be cast from `Decimal(8,2)` to `Decimal(12,2)`.
...
-- AlterTable
ALTER TABLE `invoices` ADD COLUMN `tax_toggle` BOOLEAN NULL,
    MODIFY `invoice_amount` DECIMAL(12, 2) NULL DEFAULT 0.00,
    MODIFY `tax_amount` DECIMAL(12, 2) NULL DEFAULT 0.00,
    MODIFY `payment_amount` DECIMAL(12, 2) NULL DEFAULT 0.00,
    MODIFY `discount_amount` DECIMAL(12, 2) NULL DEFAULT 0.00,
    MODIFY `sub_total` DECIMAL(12, 2) NULL DEFAULT 0.00;
